...
public void add(String csvItem) {
    ...
    if (values[0].equalsIgnoreCase("Buckets")) {
        Double total = 0.;
        bucketSizes.add(0,Double.parseDouble(values[2]));
        bucketSizes.add(1,Double.parseDouble(values[3]));
        bucketSizes.add(2,Double.parseDouble(values[4]));
